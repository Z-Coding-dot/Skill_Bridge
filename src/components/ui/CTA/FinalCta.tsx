  ...
  return (
   <Section>
    <div className="my-24 flex flex-col justify-between items-center">
            <div className="w-full sm:w-200 xl:w-350 flex max-sm:flex-col sm:items-center sm:justify-between rounded-2xl px-4 py-3 sm:px-8 lg:px-12 2xl:h-60 bg-[var(--card-bg)]">
